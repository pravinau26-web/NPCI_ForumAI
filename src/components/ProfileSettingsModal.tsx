...
import { X, Save, User as UserIcon, Mail, Building, FileText, ImageIcon, Sparkles, Lock } from "lucide-react";
      ...
      <div className="bg-white dark:bg-slate-950 max-w-xl w-full rounded-3xl border border-slate-200 dark:border-slate-800 shadow-2xl overflow-hidden flex flex-col max-h-[90vh] animate-in zoom-in-95 duration-150">
        ...
        <form onSubmit={handleSubmit} className="flex-1 overflow-y-auto p-6 md:p-8 space-y-6">
          ...
          <div className="pt-4 border-t border-slate-100 dark:border-slate-800 space-y-3 text-left">
            ...
            {passwordError && (
              <div className="p-2.5 bg-rose-50 text-rose-600 text-xs font-bold rounded-xl border border-rose-200">
                ⚠️ {passwordError}
              </div>
            )}
            {passwordMsg && (
              <div className="p-2.5 bg-emerald-50 text-emerald-600 text-xs font-bold rounded-xl border border-emerald-200">
                ✅ {passwordMsg}
              </div>
            )}
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
              <input
                ...
                className="bg-slate-50 dark:bg-slate-900 text-slate-800 dark:text-slate-100 px-3.5 py-2 rounded-xl text-xs border border-slate-200 dark:border-slate-800 focus:outline-none focus:border-amber-500 font-medium"
              />
              <input
                type="password"
            ...
            <button
              ...
              className="py-2 px-4 bg-amber-500 hover:bg-amber-600 text-white text-xs font-bold rounded-xl transition cursor-pointer flex items-center gap-1.5"
            >
              <Lock className="w-3.5 h-3.5" />
              <span>Update Password Only</span>
            </button>
          </div>
