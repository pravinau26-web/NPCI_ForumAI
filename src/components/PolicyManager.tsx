                      ...
                      {msg.citations && msg.citations.length > 0 && (
                        <div className="mt-1 space-y-1">
                          {msg.citations.map((c, idx) => (
                            <div key={idx} className="text-[9px] bg-slate-150 dark:bg-slate-800 px-1.5 py-0.5 rounded font-mono text-slate-600 dark:text-slate-300 truncate">
                              Cite: {c.docTitle} (v{c.version}) - {c.section}
                            </div>
                          ))}
                        </div>
                      )}
